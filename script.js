...
const translations = {
  sv: {
    ...
    about_text: "Casa Lixenstrand erbjuder bekvämt boende<br><br>• 200 m² radhus<br>• Lugnt, inhägnat område med fin trädgård<br>• 3 sovrum med egna badrum (6 sovplatser)<br>• Fullt utrustat kök med stor kyl/frys<br>• 3 balkonger, uteplats och garageuppfart<br>• Tvättstuga och toalett i källaren<br>• Biorum med projektor<br>• 2 höj- och sänkbara skrivbord + 32\" 4K-skärmar (perfekt för distansjobb!)<br>• Gigabit-internet<br>• 7 kW solpaneler och 5 kWh batteri<br><br>Huset är smakfullt inrett och har alla moderna bekvämligheter du behöver för en avkopplande semester.",
  ...
  en: {
    ...
    about_text: "Casa Lixenstrand offers comfortable accommodation for up to 6 people.<br><br>• 200 m² townhouse<br>• Peaceful gated community with a lovely garden<br>• 3 bedrooms with private bathrooms (6 sleeping places)<br>• Fully equipped kitchen with large fridge/freezer<br>• 3 balconies, patio and garage driveway<br>• Laundry room and toilet in basement<br>• Cinema room with projector<br>• 2 height-adjustable desks + 32\" 4K screens (perfect for remote work!)<br>• Gigabit internet<br>• 7 kW solar panels and 5 kWh battery<br><br>The house is tastefully decorated and has all modern amenities you need for a relaxing vacation.",
